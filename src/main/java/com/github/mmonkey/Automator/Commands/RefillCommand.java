...
public class RefillCommand extends CommandAbstract {

    public RefillCommand(Automator plugin) {
        super(plugin);
    }
    ...
    public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
        ...
        if (setting.isEnabled()) {
            ...
            player.sendMessage(Text.of(TextColors.GOLD, "Automatic refilling has been disabled."));

        } else {

            setting.setEnabled(true);
            this.saveCommandSetting(player, setting);
            player.sendMessage(Text.of(TextColors.GREEN, "Automatic refilling has been enabled."));
